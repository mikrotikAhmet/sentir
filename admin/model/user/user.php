...
class ModelUserUser extends Model {
    ...
    public function updateAuthToken($auth_token,$user_id){
        
        $this->db->query("UPDATE `" . DB_PREFIX . "user` SET two_factor = '".$this->db->escape($auth_token)."' WHERE user_id = '".(int) $user_id."'");
    }
